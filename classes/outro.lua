function love.load()
	...
	CURRENT_LEVEL = 5 -- sets current level. 1 = introOne.
	...
	text2 = "This has been an excellent triumph against the forces of evil!"
...
function love.draw()
	...
	if DISPLAY_DEBUG == true then
		...
		love.graphics.print("Aventyr-outro.lua(1.0) LOVE: 0.8.0", 5, 5)
